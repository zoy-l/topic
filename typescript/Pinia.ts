...
declare function defineStore<Id, State, Getter, Action>(
  store: StoreOpitons<Id, State, Getter, Action>
): StoreOpitons<Id, State, Getter, Action>

interface StoreOpitons<Id, State, Getter, Action> {
  id: Id
  state: () => State
  getters: Getter & ThisType<State & Getter>
  actions: Action & ThisType<State & Getter & Action>
}
